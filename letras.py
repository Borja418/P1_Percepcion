...
A = np.float32([[0,0,0], [0.5,0,-2], [1,0,-5], [1.5,0,-2], [2,0,0]]).reshape(-1,3)
U = np.float32([[0,0,-5], [0,0,-1], [0.5,0,-0.2], [1,0,0], [1.5,0,-0.2], [2,0,-1], [2,0,-5]]).reshape(-1,3)
N = np.float32([[0,0,0], [0,0,-5], [2,0,0], [2,0,-5]]).reshape(-1,3)
Y = np.float32([[0,0,-5], [1,0,-2.5], [1,0,0], [2,0,-5]]).reshape(-1,3)